...
const BOT_NAME = process.env.BOT_NAME || " ᴅɪᴀʙʟᴇssᴇ_ᴠ1 ";
const OWNER_NAME = process.env.OWNER_NAME || "ᴍᴀᴛsᴜ";

const MENU_IMAGE_URL = process.env.MENU_IMAGE_URL || "https://files.catbox.moe/hrpf0i.jpg";
...
const AUTO_STATUS_MSG = process.env.AUTO_STATUS_MSG || "ʏᴏᴜʀ sᴛᴀᴛᴜᴛs ʜᴀs ʙᴇᴇɴ sᴇᴇɴ ʙʏ ᴅɪᴀʙʟᴇssᴇ_ᴠ1 🌺";
const DEV = process.env.DEV || 'ᴍᴀᴛsᴜ';
            ...
            case 'sunset':
                ...
                await conn.sendMessage(from, {
                    ...
                    forwardedNewsletterMessageInfo: {
                        ...
                        newsletterName: "ᴅɪᴀʙʟᴇssᴇ_ᴠ1",
                        serverMessageId: 200
                    },
                        externalAdReply: {
                            title: "📃 ᴅɪᴀʙʟᴇssᴇ Command Menu",
...
function gracefulShutdown() {
  ...
  isShuttingDown = true;
  console.log("\n🛑 Shutting down ᴅɪᴀʙʟᴇssᴇ_ᴠ1 server...");
